...
void main() {
  group('Logger Initialization and Configuration', () {
    ...
    test(
      'Logger should initialize with specified log level and strategies',
      () {
        expect(
          () => logger.initialize(
  ...
  group('Event Specific Logging', () {
    ...
    test('Logger should handle multiple strategies for a generic event', () {
      logger.log(
        'Generic event affecting multiple strategies',
