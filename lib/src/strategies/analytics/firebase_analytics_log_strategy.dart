...
class FirebaseAnalyticsLogStrategy extends LogStrategy {  
  ...
  FirebaseAnalyticsLogStrategy({super.logLevel = LogLevel.none, super.supportedEvents});
  ...
  Future<void> log({dynamic message, LogEvent? event}) async {
    try {
      if (shouldLog(event: event)) {   
        ...
        if (event != null) {
          final FirebaseAnalyticsLogEvent analyticsEvent = event as FirebaseAnalyticsLogEvent;        
          _analytics.logEvent(
      ...
      developer.log('Error during Firebase Analytics logging: $e',
          name: 'FirebaseAnalyticsLogStrategy', error: e, stackTrace: stack,);
    }
  }
  ...
  Future<void> error({dynamic error, StackTrace? stackTrace, LogEvent? event}) async {
    try {
      ...
      developer.log('Error during Firebase Analytics error handling: $e',
          name: 'FirebaseAnalyticsLogStrategy', error: e, stackTrace: stack,);
    }
  }
  ...
  Future<void> fatal({error, StackTrace? stackTrace, LogEvent? event}) async {
    try {
      ...
      developer.log('Error during Firebase Analytics fatal error handling: $e',
          name: 'FirebaseAnalyticsLogStrategy', error: e, stackTrace: stack,);
    }
  }  
}
