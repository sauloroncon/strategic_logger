...
///
/// This class extends [LogEvent] to include functionality for logging errors with Sentry,
/// including optional stack trace information. It is tailored to log error messages and their associated
/// stack traces to Sentry, aiding in debugging and monitoring application health.
///
/// The class is designed to provide a structured format for error reporting, making it easier to
/// understand the context and specifics of an error when viewed in the Sentry dashboard.
///
/// Example:
/// ```dart
...
/// ```
class SentryLogEvent extends LogEvent {
  ...
  /// Returns a map which can be directly used for logging to Sentry.
  @override
